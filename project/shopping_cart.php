...
<head>
   ...
   <title>Shopping Cart-DC125135 CHENPENGYU</title>
...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <p class="sub-total">sub total : <span><i class="fas fa-dollar-sign"></i> <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
